...
for(i in 1:length(model_fits)){
  ...
  cat('\n\n### ', network_name, '{.tabset}\n\n') 
  cat('\n\n#### Plot\n\n')
  perc_plot <- ggplot(proportion_variance_tables[[i]], aes(y = percent, x = out_of, fill = source)) + 
    ...
    jftheme
  print(plot_predictions(as.data.table(model_fit@frame), model_fit) + perc_plot +
